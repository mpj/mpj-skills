...
1. Writer sends a **pitch note**: where the piece opens, the spine, where the analogy sits, where tension and caveats go, how it ends. 130-190 words.
...
- **Ground the vocabulary before leaning on it.** Each part introduces at most three new terms or names, defines each in plain words at first use, and no term is used in part N that was not grounded in parts 1 to N. The ground-truth sheet supplies the definitions; the writer supplies the plain words.
...
- **A checkpoint closes every part**, in the writer's voice: it names the terms the part introduced and invites the reader either to say continue or to ask about any of them and how they relate. Vary the wording. A checkpoint is an invitation, never a preview of what comes next (a preview is signposting, and the tightening seat may cut it).
