...
- **A checkpoint closes every part**, as a self-descriptive labelled block outside the prose, modelled on the chapter ends of Deutsch's *The Beginning of Infinity*: TERMINOLOGY (each term the part introduced, in italics, with a definition of a sentence or two), SUMMARY (a short paragraph, one to three sentences, on what the part established), CONTINUE OR ASK (one line in the writer's voice); labels in bold capitals. Ruled by the reader 2026-09-12 over the earlier closing paragraph, which did not say what it was. Never a preview of what comes next (a preview is signposting, and the tightening seat may cut it). Full form in the `serial` skill.
